...
# Set up main strings: C, E, A
strings = {
    1: StringState(1, 261.6),  # C
    2: StringState(2, 329.6),  # E
    3: StringState(3, 440.0)   # A
}

# Key mapping
key_map = {
    '1': (1, None),  # Open string trigger
    '4': (2, None),
    '7': (3, None),
    'z': (1, 1), 'x': (1, 2), 'c': (1, 3), 'v': (1, 4), 'b': (1, 5), 'n': (1, 6), 'm': (1, 7), ',': (1, 8), '.': (1, 9), '/': (1, 10),
    'a': (2, 1), 's': (2, 2), 'd': (2, 3), 'f': (2, 4), 'g': (2, 5), 'h': (2, 6), 'j': (2, 7), 'k': (2, 8), 'l': (2, 9), ';': (2, 10),
    'q': (3, 1), 'w': (3, 2), 'e': (3, 3), 'r': (3, 4), 't': (3, 5), 'y': (3, 6), 'u': (3, 7), 'i': (3, 8), 'o': (3, 9), 'p': (3, 10),
}
